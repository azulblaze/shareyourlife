...
public interface GroupService {
	...
	public boolean allowToGroup(long my_id,long user_id,long group_id) throws Exception;
	
	public void applyPermisson(long my_id,long user_id,long group_id) throws Exception;
