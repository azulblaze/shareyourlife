...
public class CommentsDAOImpl extends SqlMapClientDaoSupport implements CommentsDAO {
	...
	public void insert(Comments record) {
		getSqlMapClientTemplate().insert("comments.abatorgenerated_insert",
				record);
	}
	...
	public int updateByPrimaryKeyWithoutBLOBs(Comments record) {
		int rows = getSqlMapClientTemplate().update(
				"comments.abatorgenerated_updateByPrimaryKey", record);
		return rows;
	}
	...
	public int updateByPrimaryKeyWithBLOBs(Comments record) {
		int rows = getSqlMapClientTemplate().update(
				"comments.abatorgenerated_updateByPrimaryKeyWithBLOBs", record);
		return rows;
	}
	...
	public int updateByPrimaryKeySelective(Comments record) {
		int rows = getSqlMapClientTemplate().update(
				"comments.abatorgenerated_updateByPrimaryKeySelective", record);
		return rows;
	}
	...
	public List<Comments> selectByExampleWithoutBLOBs(CommentsExample example) {
		List<Comments> list = (List<Comments>) getSqlMapClientTemplate()
				.queryForList("comments.abatorgenerated_selectByExample",
						example);
		return list;
	}
	...
	public List<Comments> selectByExampleWithBLOBs(CommentsExample example) {
		List<Comments> list = (List<Comments>) getSqlMapClientTemplate()
				.queryForList(
						"comments.abatorgenerated_selectByExampleWithBLOBs",
						example);
		return list;
	}
	...
	public Comments selectByPrimaryKey(Long id) {
		...
		Comments record = (Comments) getSqlMapClientTemplate().queryForObject(
				"comments.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int deleteByExample(CommentsExample example) {
		int rows = getSqlMapClientTemplate().delete(
				"comments.abatorgenerated_deleteByExample", example);
		return rows;
	}
	...
	public int deleteByPrimaryKey(Long id) {
		...
		key.setId(id);
		int rows = getSqlMapClientTemplate().delete(
				"comments.abatorgenerated_deleteByPrimaryKey", key);
		return rows;
	}
	...
	public int countByExample(CommentsExample example) {
		Integer count = (Integer) getSqlMapClientTemplate().queryForObject(
				"comments.abatorgenerated_countByExample", example);
		return count;
	}
	...
	public int updateByExampleSelective(Comments record, CommentsExample example) {
		...
		int rows = getSqlMapClientTemplate().update(
				"comments.abatorgenerated_updateByExampleSelective", parms);
		return rows;
	}
	...
	public int updateByExampleWithBLOBs(Comments record, CommentsExample example) {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = getSqlMapClientTemplate().update(
				"comments.abatorgenerated_updateByExampleWithBLOBs", parms);
		return rows;
	}
	 ...
	 * @abatorgenerated  Wed Aug 05 16:18:34 CST 2009
	 */
	public int updateByExampleWithoutBLOBs(Comments record,
			CommentsExample example) {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = getSqlMapClientTemplate().update(
				"comments.abatorgenerated_updateByExample", parms);
		return rows;
	}
