//add device to pictures_parameter
...
ENGINE = InnoDB;
go
INSERT pictures_parameter (id_pictures, upload_account, upload_time,status,title,description,addtion_info) select * from pictures_parameter_tmp;
go
